			...
			style={{
				...
				<div className="navbar-brand">
					<NavLink className="navbar-item" to="/" activeClassName="is-active">
						...
						src="http://images.clipartpanda.com/medieval-knight-clipart-knight-clipart-LiKX5aeia.jpeg"
						width="30px" alt="" />
				...
				<div className={ this.state.isActive ? 'navbar-menu is-active' : 'navbar-menu' } >
					...
					<div className="navbar-end">
						...
						<a className="navbar-item" href="https://twitter.com/aaronklaser">
							<span className="icon has-text-info" style={{ color: '#0084FF' }}>
								<i className="fab fa-lg fa-twitter"></i>
							</span>
						</a>
						<a className="navbar-item" href="http://resume.aaronklaser.com">
							Resume <span className="icon" style={{ color: '#0077b5', marginLeft: 5 }}>
